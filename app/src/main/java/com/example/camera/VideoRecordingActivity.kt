...
class VideoRecordingActivity : AppCompatActivity() {
    ...
    private lateinit var viewBinding: ActivityVideoRecordingBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding = ActivityVideoRecordingBinding.inflate(layoutInflater)
    ...
    private val captureListener = Consumer<VideoRecordEvent> { event ->
        if (event is VideoRecordEvent.Finalize) {
            // Handle video capture finalization
        }
    }
